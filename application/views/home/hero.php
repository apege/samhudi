...
<section class="position-relative d-flex align-items-center justify-content-start text-center bg-hero-section -mt-20" style="padding-top: 80px; background-image: url('<?= base_url('assets/images/' . $banner) ?>');">
    ...
    <div class="position-relative text-white hero-content" style="padding-top: clamp(1.5rem, 5vw, 4rem); padding-left: 4rem;">
        ...
        <p class="hero-subtitle" style="font-family: 'Poppins', sans-serif; font-weight: 400; font-style: italic; font-size: clamp(1.2rem, 2.6vw, 1.6rem); color: #D9D9D9; opacity: 1; margin-top: 0.4rem;">
